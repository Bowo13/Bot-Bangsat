...
/////////////////
const BotName = 'Bot Bangsat'; 
const instagram = 'https://www.instagram.com/anime_desu.0'; 
const telegram = 'gakpunya'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by KOfficial')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by KOfficial`)
})
